#' XY pad controller
#' @description Create a XY pad controller.
#'
...
#'
#' @return A XY pad input control that can be added to a UI definition.
...
#' @description Change a XY pad input on the client.
#'
